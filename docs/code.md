...
## License
The [NG-CFFDRS scripts](https://github.com/nrcan-cfs-fire/cffdrs-ng) are licensed under the [Mozilla Public License 2.0](https://mozilla.org/MPL/2.0/). A copy of the license is also available on the [GitHub repository](https://github.com/nrcan-cfs-fire/cffdrs-ng/blob/main/LICENSE.txt).
